		...
		var onMouseMoveFn = function(ev) {
				requestAnimationFrame(function() {
					...
					var mousepos = getMousePos(ev),
						// transform values
						rotX = tiltRotation.rotateX ? initTransform.rotateX -  (4 * tiltRotation.rotateX / win.height * mousepos.y - tiltRotation.rotateX) : 0,
						rotY = tiltRotation.rotateY ? initTransform.rotateY -  (4 * tiltRotation.rotateY / win.width * mousepos.x - tiltRotation.rotateY) : 0;
